...
/**
 * Controller for reporting a LOST item. Location and image are optional.
 */
public class ReportLostController {
    ...
    private void handleSubmit() {
        ...
        try {
            ...
            Dialogs.info("Report Submitted",
                    "Lost item reported! " + matches + " possible match" + (matches == 1 ? "" : "es") + " found.");
